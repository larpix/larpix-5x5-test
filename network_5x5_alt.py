...
def main(vdda, vddd, verbose=True):
    ...
    conf_south(c, chip32_key, chip42_key, 42, IO_GROUP, IO_CHAN)
    ...
    conf_south(c,chip42_key,chip52_key,52,IO_GROUP,IO_CHAN)
    ...
    for key in all_keys:
        ...
        if ok:
            print('Configured chip:', key)
        else:
            print('Unable to configure', key)
